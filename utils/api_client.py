...
class APIClient:
    ...
    def trigger_attendance_sync(self, device_id: str, days: int) -> Tuple[bool, Any]:
        """
        Trigger N-days attendance sync on ESP32
        
        Args:
            device_id: ESP32 device ID
            days: Number of days to sync (1-30)
    ...
    def get_sync_history(self, device_id: str, limit: int = 10) -> Tuple[bool, Any]:
        """
        Get sync trigger history
